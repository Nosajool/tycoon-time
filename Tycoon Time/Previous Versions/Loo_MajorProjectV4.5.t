...
%Plan for %Version 4.6----Work on Store Timers
...
procedure ChooseCompanyName
	...
	if ptinrect (x, y, j1, k1, j2, k2) then
	    ...
	    c1 := 100
	    d1 := 600
	    Font.Draw (companyName, c1, d1, font1, blue)
	end if
	if ptinrect (x, y, g1, h1, g2, h2) then
	    ...
	    companyName := companyName - companyName (companyLength)
	end if
