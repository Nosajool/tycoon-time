...
%Version 3.7----
%Plan for Version 3.7----Read names of workshop toys?/whatever product and purchase them to sell in store. Set quantity etc...
...
var maxqueue : int := 5 %Change the "5" to whatever the maximum queue is
...
procedure Recipes
	...
	if counter = numMatType then
		...
		if z = 1 then
			...
			numGems (matType (j)) -= numMat (matType (j))
