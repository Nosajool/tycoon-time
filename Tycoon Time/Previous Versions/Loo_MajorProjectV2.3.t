...
procedure HireWorkerMenu
	...
	if x > i * 200 - 65 and x < i * 200 + 80 and y > 500 - 130 and y < 500 - 80 then
	    ...
	    if z = 1 then
		drawfillbox (700, 200, 750, 250, black)
		drawfillbox (700 + 1, 200 + 1, 750 - 1, 250 - 1, white)
		Pic.ScreenLoad ("pics/workers/" + intstr (hireWorker (i)) + ".bmp", 700, 200, picMerge)
	    end if
	else
	    drawfillbox (i * 200 - 65, 500 - 130, i * 200 + 80, 500 - 80, black)
