...
var main : int := Window.Open ("graphics:1000;700,position:center;center,title:Loo_MajorProject,offscreenonly")
var endTime : real := 0
var x, y, z : int := 0
var numGems, gemRate : array 1 .. 7 of int
var startTime : array 1 .. 7 of real
var factoryUpgrade : array 1 .. 7, 1 .. 20 of boolean %20 is the upgrade level
var factoryCost : array 1 .. 7, 1 .. 20 of int
...
procedure DrawUpgradeBoxes
	...
	for j : 1 .. 20
	    ...
	    var boxy : int := 200 + (j * 20)
	    var boxh : int := 10
	    if x > boxx and x < boxx + boxh and y > boxy and y < boxy + boxh then
