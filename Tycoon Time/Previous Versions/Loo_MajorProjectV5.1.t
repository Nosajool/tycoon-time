...
%Plan for Version 5.2---- Still need Marketer, Salesman and Engineer
...
procedure DrawUpgradeBoxes
    ...
    Font.Draw ("in milliseconds per gem", 750, 170, font3, black)
...
procedure ViewItemsOnSale
	...
	if sitem (i).quantity > 0 then
	    ...
	    y1 -= 20
	    Font.Draw (realstr (sitem (i).timer, 0) + "s each", x1 + 30, y1, font3, black)
	    y1 -= 20
	    ...
	    y1 -= 20
	    Font.Draw (realstr (sitem (i).timer * sitem (i).quantity, 0) + "s", x1 + 30, y1, font3, black)
	    y1 -= 40
	    Font.Draw ("Total Price:", x1, y1, font3, black)
	    y1 -= 20
	    ...
	    Font.Draw (realstr ((tempTimer / 1000), 0), x1, y1, font3, black)
	else
	    x1 += 20
