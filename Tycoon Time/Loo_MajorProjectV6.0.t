...
%Version 6.0
%Last edit: January 24, 2013
%Tycoon Time

% _________          _______  _______  _______  _         __________________ _______  _______
% \__   __/|\     /|(  ____ \(  ___  )(  ___  )( (    /|  \__   __/\__   __/(       )(  ____ \
%    ) (   ( \   / )| (    \/| (   ) || (   ) ||  \  ( |     ) (      ) (   | () () || (    \/
%    | |    \ (_) / | |      | |   | || |   | ||   \ | |     | |      | |   | || || || (__
%    | |     \   /  | |      | |   | || |   | || (\ \) |     | |      | |   | |(_)| ||  __)
%    | |      ) (   | |      | |   | || |   | || | \   |     | |      | |   | |   | || (
%    | |      | |   | (____/\| (___) || (___) || )  \  |     | |   ___) (___| )   ( || (____/\
%    )_(      \_/   (_______/(_______)(_______)|/    )_)     )_(   \_______/|/     \|(_______/


%Note to Mr. Reid: If it appears as if the program isn't responding to your button clicks, press and hold down the mouse.
%It works fine at my house but the computers at school seem to have a tough time managing sounds,live timers and 168 pictures at the same time
%Also, I've been told my program looks somewhat intimidating but the instructions in my opinion explain quite nicely how
%you progress through the game. Also, you can always click the Cheat button to get maximum factory upgrades and a bunch of money.

%The files that you need to open are:
%This file: Loo_MajorProjectV6.0.t
%The advertisement: Advertisement.ppt
%   Compatible with powerpoint 2003 and open office
...
% Coding [COMPLETED]
% Comments[EVERYWHERE]
% Program Runs [COMPLETED]
%Introduction and Conclusion [COMPLETED]
%User Friendliness [Hopefully COMPLETED]
%Originality [In my opinion, ORIGINAL]
%Aesthetics [COMPLETED to the best of my artistic skills]
%Degree of difficulty [Believe me, DIFFICULT! :P, or at least the build and sell section interprets recipes from an editable text file]
%Overall imporession [Hopefully GOOD!]
%Use of pictures [168 FULL COLOR PICTURES]
%Use of Sounds [8 mp3 file sounds!]
%Use of random number [RANDOM WORKER STATS]
%Use of data files [RECIPES,SAVEFILE,HIGH SCORES]
% Time Management [HOPEFULLY GOOD :D]
...
%Version 5.5----Title and Conclusion Screen
%Version 5.6----Sounds
%Version 5.7----Advertisement and Instructions
%Version 6.0----DONE WOOT!


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Note To Self
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Declaration of Global Variables. Local ones are in procedures or functions
...
%%%%%%%%%%%%%%%%%%%%%%
process buildSound
    Music.PlayFile ("sounds/build.mp3")
end buildSound
%%%%%%%%%%%%%%%%%%%%%
process advertisementSound
    Music.PlayFile ("sounds/advertisement.mp3")
end advertisementSound
%%%%%%%%%%%%%%%%%%%%%
process winSound
    Music.PlayFile ("sounds/win.mp3")
end winSound
%%%%%%%%%%%%%%%%%%%%%
process moneySound
    Music.PlayFile ("sounds/money.mp3")
end moneySound
%%%%%%%%%%%%%%%%%%%%
% process clickSound
%     Music.PlayFile ("sounds/click.mp3")
% end clickSound
%%%%%%%%%%%%%%%%%%%%
process introSound
    Music.PlayFile ("sounds/intro.mp3")
end introSound
%%%%%%%%%%%%%%%%%%%%
process outroSound
    Music.PlayFile ("sounds/outro.mp3")
end outroSound
%%%%%%%%%%%%%%%%%%%%
process powerSound
    Music.PlayFile ("sounds/power.mp3")
end powerSound
...
procedure Instructions
    ...
    loop
	Pic.ScreenLoad ("pics/Instructions/" + intstr (insP) + ".bmp", 0, 0, picCopy)
...
procedure MainMenu
	...
	drawfillbox (x1, y1, x2, y2, yellow)
	drawbox (x1, y1, x2, y2, black)
	Font.Draw ("Instructions", x1 + 5, y1 + 20, font3, black)
	if z = 1 then
	    Instructions
	end if
    else
	drawfillbox (x1, y1, x2, y2, 11)
	drawbox (x1, y1, x2, y2, black)
	Font.Draw ("Instructions", x1 + 5, y1 + 20, font3, black)
    end if
